            ...
            <div class="page-header">
                <div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Sumber Anggaran</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div>
                                <h5 class="card-title">Tambah Sumber Anggaran</h5>
                            </div>
                        </div>
                            ...
                            <div class="form-content">
                                ...
                                <div class="row row-xs align-items-center mb-4">
                                    ...
                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                        <input type="text" name="kode_anggaran" class="form-control" placeholder="Kode Sumber Anggaran"> 
                                    </div>
                                </div>
                                ...
                                <div class="row row-xs align-items-center mb-4">
                                    ...
                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                        <input type="text" name="nama_anggaran" class="form-control" placeholder="Nama Sumber Anggaran">
                                    </div>
                                </div>
